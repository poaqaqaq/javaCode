...
public class JdbcPreStatement2Test {
...
//            preparedStatement.executeUpdate();
            ...
            String path = JdbcPreStatement2Test.class.getResource("text").getPath();

            //如果加上/，则代表根路径！所有的文件最后都会编译至out文件夹
//            String path = JdbcPreStatement2Test.class.getResource("/a.txt").getPath();
    ...
    public void setBlob() {
        ...
        try {
            ...
            resourceAsStream = JdbcPreStatement2Test.class.getResourceAsStream("/test.png");
